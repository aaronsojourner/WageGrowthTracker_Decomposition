...
global yourpath ""
global programspath "${yourpath}\WageGrowthTracker\programs"
global rawdatapath "${yourpath}\WageGrowthTracker\Data\rawdata" /*save cadre file here*/
global processeddatapath "${yourpath}\WageGrowthTracker\Data\processeddata" 
...
*** NEW: Add groups
// 6 age76 groups
gen age6group="16-24" if inrange(age76,16,24)
replace age6group="25-34" if inrange(age76,25,34)
replace age6group="35-44" if inrange(age76,35,44)
replace age6group="45-54" if inrange(age76,45,54)
replace age6group="55-64" if inrange(age76,55,64)
replace age6group="65+" if age76>=65 & age76 ~=. 

// 4 age76 x Switcher groups
gen age4Swgroup="16-29 Switcher" 	if inrange(age76,16,29) & jstayergroup=="Job Switcher"
replace age4Swgroup="16-29 Stayer" 	if inrange(age76,16,29) & jstayergroup=="Job Stayer"
replace age4Swgroup="30-44 Switcher" if inrange(age76,30,44)  & jstayergroup=="Job Switcher"
replace age4Swgroup="30-44 Stayer"   if inrange(age76,30,44)  & jstayergroup=="Job Stayer"
replace age4Swgroup="45-59 Switcher" if inrange(age76,45,59)  & jstayergroup=="Job Switcher"
replace age4Swgroup="45-59 Stayer" 	 if inrange(age76,45,59)  & jstayergroup=="Job Stayer"
replace age4Swgroup="60+ Switcher"   if age76>=60 & age76 ~=. & jstayergroup=="Job Switcher"
replace age4Swgroup="60+ Stayer"     if age76>=60 & age76 ~=. & jstayergroup=="Job Stayer"
...
save "${rawdatapath}\WGT_groups_v2.dta", replace
